...
//Process group with 4 BNs
 M = (5*Z + 31)>>5;
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[96+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[156+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[36+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[36+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[156+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[96+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[36+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[156+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[36+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
...
//Process group with 5 BNs
 M = (18*Z + 31)>>5;
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[492+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[708+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[924+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1140+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[276+i] = simde_mm256_sign_epi8(min, sgn);
           }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[276+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[708+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[492+i] = simde_mm256_sign_epi8(min, sgn);
           }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[276+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[708+i] = simde_mm256_sign_epi8(min, sgn);
           }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[276+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[924+i] = simde_mm256_sign_epi8(min, sgn);
           }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[276+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1140+i] = simde_mm256_sign_epi8(min, sgn);
           }
//Process group with 6 BNs
M = (8*Z + 31)>>5;
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1452+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1548+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1644+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1740+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1836+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1356+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1356+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                min  = simde_mm256_abs_epi8(ymm0);
                ymm0 = ((simde__m256i*)cnProcBuf)[1548+i];
                min  = simde_mm256_min_epu8(min, simde_mm256_abs_epi8(ymm0));
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1452+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1356+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1548+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1356+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1644+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1356+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1740+i] = simde_mm256_sign_epi8(min, sgn);
            }
            for (int i=0;i<M;i++) {
                ymm0 = ((simde__m256i*)cnProcBuf)[1356+i];
                sgn  = simde_mm256_sign_epi8(ones, ymm0);
                ...
                sgn  = simde_mm256_sign_epi8(sgn, ymm0);
                min = simde_mm256_min_epu8(min, maxLLR);
                ((simde__m256i*)cnProcBufRes)[1836+i] = simde_mm256_sign_epi8(min, sgn);
            }
