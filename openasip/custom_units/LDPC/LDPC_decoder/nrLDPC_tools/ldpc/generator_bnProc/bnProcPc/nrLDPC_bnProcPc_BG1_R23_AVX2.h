...
// Process group with 2 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [3456];
...
// Process group with 3 CNs 
 M = (5*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [3840];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 4 CNs 
 M = (3*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [5760];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 5 CNs 
 M = (7*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [6912];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 6 CNs 
 M = (8*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [9600];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 11 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [12672];
            for (int i=0,j=0;i<M;i++,j+=2) {
            ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
            ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
            ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 12 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [13056];
            for (int i=0,j=0;i<M;i++,j+=2) {
            ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
            ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
            ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
