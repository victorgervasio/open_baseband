...
// Process group with 4 CNs 
 M = (2*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [7296];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 5 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [8064];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 6 CNs 
 M = (5*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [8448];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 7 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [10368];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 8 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [10752];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 13 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [11136];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 14 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [11520];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 16 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [11904];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
