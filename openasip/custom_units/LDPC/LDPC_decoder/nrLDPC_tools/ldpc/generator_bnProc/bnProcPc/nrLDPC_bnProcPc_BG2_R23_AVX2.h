...
// Process group with 2 CNs 
 M = (3*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [1152];
...
// Process group with 3 CNs 
 M = (5*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [2304];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 4 CNs 
 M = (3*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [4224];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[72 + j]);
...
// Process group with 5 CNs 
 M = (2*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [5376];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 6 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [6144];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
