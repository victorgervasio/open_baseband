...
// Process group with 5 CNs 
 M = (2*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [14592];
...
// Process group with 6 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [15360];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 7 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [15744];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 10 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [17280];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 13 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [18048];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 14 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [18432];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 16 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [18816];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with <23 CNs 
 M = (1*Z + 31)>>5;
    ...
    p_llrRes        = (simde__m256i*) &llrRes       [19584];
        for (int i=0,j=0;i<M;i++,j+=2) {
        ymmRes0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j]);
        ymmRes1 = simde_mm256_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ymm0 = simde_mm256_cvtepi8_epi16(p_bnProcBuf[24 + j]);
