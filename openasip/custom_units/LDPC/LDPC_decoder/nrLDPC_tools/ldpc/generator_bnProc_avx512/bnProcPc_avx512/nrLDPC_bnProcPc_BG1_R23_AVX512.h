...
// Process group with 1 CNs 
 M = (9*Z + 63)>>6;
    ...
    p_llrRes        = (simde__m512i*) &llrRes       [0];
            ...
            zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[j + 1]);
...
// Process group with 2 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [3456];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [3456];
    p_llrRes        = (simde__m512i*) &llrRes       [3456];
            for (int i=0,j=0;i<M;i++,j+=2) {
...
// Process group with 3 CNs 
 M = (5*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [4224];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [3840];
    p_llrRes        = (simde__m512i*) &llrRes       [3840];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 4 CNs 
 M = (3*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [9984];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [5760];
    p_llrRes        = (simde__m512i*) &llrRes       [5760];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 5 CNs 
 M = (7*Z + 63)>>6;
    ...
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [6912];
    p_llrRes        = (simde__m512i*) &llrRes       [6912];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[336 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[336 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 6 CNs 
 M = (8*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [28032];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [9600];
    p_llrRes        = (simde__m512i*) &llrRes       [9600];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[288 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[288 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[384 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[384 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[480 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[480 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 11 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [46464];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [12672];
    p_llrRes        = (simde__m512i*) &llrRes       [12672];
            for (int i=0,j=0;i<M;i++,j+=2) {
            zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
            zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 12 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [50688];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [13056];
    p_llrRes        = (simde__m512i*) &llrRes       [13056];
            for (int i=0,j=0;i<M;i++,j+=2) {
            zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
            zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
