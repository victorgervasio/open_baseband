...
// Process group with 4 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [16128];
...
// Process group with 6 CNs 
 M = (2*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [19584];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [16896];
    p_llrRes        = (simde__m512i*) &llrRes       [16896];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[24 + j]);
...
// Process group with 9 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [44160];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [20352];
    p_llrRes        = (simde__m512i*) &llrRes       [20352];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 10 CNs 
 M = (4*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [47616];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [20736];
    p_llrRes        = (simde__m512i*) &llrRes       [20736];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[48 + j]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[432 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[432 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 11 CNs 
 M = (3*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [62976];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [22272];
    p_llrRes        = (simde__m512i*) &llrRes       [22272];
            for (int i=0,j=0;i<M;i++,j+=2) {
            zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
            zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[36 + j]);
           ...
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            ...
            zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[288 + j +1]);
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[324 + j]);
            zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
            zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[324 + j +1]);
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[360 + j]);
            zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
            zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[360 + j +1]);
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
            zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
            zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 12 CNs 
 M = (4*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [75648];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [23424];
    p_llrRes        = (simde__m512i*) &llrRes       [23424];
            for (int i=0,j=0;i<M;i++,j+=2) {
            zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
            zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[48 + j]);
           ...
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[528 + j]);
            zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
            zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[528 + j +1]);
           zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
            zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
            zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
            zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 13 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [94080];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [24960];
    p_llrRes        = (simde__m512i*) &llrRes       [24960];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 28 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [99072];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [25344];
    p_llrRes        = (simde__m512i*) &llrRes       [25344];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[276 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[276 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[288 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[288 + j +1]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[312 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[312 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[324 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[324 + j +1]);
...
// Process group with 30 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [109824];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [25728];
    p_llrRes        = (simde__m512i*) &llrRes       [25728];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
       ...
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        ...
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[336 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[348 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[348 + j +1]);
       zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
