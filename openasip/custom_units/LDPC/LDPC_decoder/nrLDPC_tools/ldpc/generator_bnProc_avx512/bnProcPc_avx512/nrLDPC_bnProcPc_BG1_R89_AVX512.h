...
// Process group with 2 CNs 
 M = (3*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [384];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [384];
    p_llrRes        = (simde__m512i*) &llrRes       [384];
            for (int i=0,j=0;i<M;i++,j+=2) {
...
// Process group with 3 CNs 
 M = (21*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [2688];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [1536];
    p_llrRes        = (simde__m512i*) &llrRes       [1536];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        ...
        zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[504 + j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[504 + j +1]);
        zmmRes1 = simde_mm512_adds_epi16(zmmRes1, zmm1); 
        zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
        zmmRes0 = simde_mm512_adds_epi16(zmmRes0, zmm0);
        zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 5 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [28416];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [9984];
    p_llrRes        = (simde__m512i*) &llrRes       [9984];
        for (int i=0,j=0;i<M;i++,j+=2) {
        zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
        zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
        zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
