...
// Process group with 2 CNs 
 M = (3*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [1152];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [1152];
    p_llrRes        = (simde__m512i*) &llrRes       [1152];
            for (int i=0,j=0;i<M;i++,j+=2) {
...
// Process group with 3 CNs 
 M = (5*Z + 63)>>6;
    ...
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [2304];
    p_llrRes        = (simde__m512i*) &llrRes       [2304];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 4 CNs 
 M = (3*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [9216];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [4224];
    p_llrRes        = (simde__m512i*) &llrRes       [4224];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[36 + j]);
...
// Process group with 5 CNs 
 M = (2*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [13824];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [5376];
    p_llrRes        = (simde__m512i*) &llrRes       [5376];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 6 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [17664];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [6144];
    p_llrRes        = (simde__m512i*) &llrRes       [6144];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
