...
// Process group with 2 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [6912];
...
// Process group with 4 CNs 
 M = (2*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [7680];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [7296];
    p_llrRes        = (simde__m512i*) &llrRes       [7296];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
...
// Process group with 5 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [10752];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [8064];
    p_llrRes        = (simde__m512i*) &llrRes       [8064];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 6 CNs 
 M = (5*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [12672];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [8448];
    p_llrRes        = (simde__m512i*) &llrRes       [8448];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
      ...
      zmmRes1 = simde_mm512_adds_epi16(zmmRes1,zmm1); 
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[300 + j]);
       zmmRes0 = simde_mm512_adds_epi16(zmmRes0,zmm0);
       zmm1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[300 + j +1]);
      zmmRes1 = simde_mm512_adds_epi16(zmmRes1,zmm1); 
       zmm0    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j]);
       zmmRes0 = simde_mm512_adds_epi16(zmmRes0,zmm0);
       zmm1    = simde_mm512_cvtepi8_epi16(p_llrProcBuf[j +1 ]);
...
// Process group with 7 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [24192];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [10368];
    p_llrRes        = (simde__m512i*) &llrRes       [10368];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 8 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [26880];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [10752];
    p_llrRes        = (simde__m512i*) &llrRes       [10752];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 13 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [29952];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [11136];
    p_llrRes        = (simde__m512i*) &llrRes       [11136];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 14 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [34944];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [11520];
    p_llrRes        = (simde__m512i*) &llrRes       [11520];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
...
// Process group with 16 CNs 
 M = (1*Z + 63)>>6;
    p_bnProcBuf     = (simde__m256i*) &bnProcBuf    [40320];
    p_llrProcBuf    = (simde__m256i*) &llrProcBuf   [11904];
    p_llrRes        = (simde__m512i*) &llrRes       [11904];
        for (int i=0,j=0;i<M;i++,j+=2) {
       zmmRes0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j]);
       zmmRes1 = simde_mm512_cvtepi8_epi16(p_bnProcBuf [j +1]);
       zmm0 = simde_mm512_cvtepi8_epi16(p_bnProcBuf[12 + j]);
