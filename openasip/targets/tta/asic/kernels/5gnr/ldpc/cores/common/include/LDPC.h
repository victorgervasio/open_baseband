...
private:
    ...
    void checkNodeOperation(const etl::vector<etl::vector<float, MAX_ZC>, MAX_CHECK_NODE_DEGREE>& msgIn, etl::vector<etl::vector<float, MAX_ZC>, MAX_CHECK_NODE_DEGREE>& msgOut);
	template<typename T>
